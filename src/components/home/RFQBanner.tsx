        ...
        <div className="grid lg:grid-cols-2 gap-10 items-center">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <a href="tel:+917551120242">
                <Button size="lg" variant="outline" className="w-full sm:w-auto">
                  <Phone className="mr-2 h-5 w-5" />
                  Call: +91 755-112-0242
                </Button>
              </a>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="bg-card rounded-xl p-6 border border-border shadow-card hover:shadow-lg transition-shadow">
              ...
              >
                +91 755-112-0242 <ArrowRight className="h-4 w-4" />
              </a>
            </div>
            ...
            <div className="bg-card rounded-xl p-6 border border-border shadow-card hover:shadow-lg transition-shadow">
              ...
              >
                sales@vendorhub.com <ArrowRight className="h-4 w-4" />
              </a>
            </div>
          </motion.div>
        </div>
