        ...
        {showForm ? (
          ...
          <motion.div key="list" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="space-y-6">
            <div className="flex items-center justify-between flex-wrap gap-4">
              <div><h1 className="text-2xl font-display font-bold">Delivery Pincodes</h1><p className="text-muted-foreground text-sm">Manage pincode-based delivery estimation</p></div>
