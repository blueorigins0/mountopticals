        ...
        {showForm ? (
          <motion.div key="form" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="space-y-6">
            <div className="flex items-center gap-4">
              ...
              <h1 className="text-2xl font-display font-bold">{editing ? "Edit Slide" : "Add Hero Slide"}</h1>
            </div>
          ...
          <motion.div key="list" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="space-y-6">
            <div className="flex items-center justify-between">
              <div><h1 className="text-2xl font-display font-bold">Hero Slides</h1><p className="text-muted-foreground text-sm">Manage homepage hero slider</p></div>
