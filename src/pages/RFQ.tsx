...
export default function RFQ() {
  ...
  const { user } = useAuth();
  const { items: rfqItems, itemCount, updateQuantity, removeFromCart, clearCart } = useRFQCart();
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead title="Request for Quotation (RFQ)" description="Submit bulk order requests and get competitive pricing on VendorHub industrial products." />
      <Header />
      ...
      <main className="pt-4 pb-20">
        <div className="container mx-auto px-4">
          ...
          <div className="grid lg:grid-cols-12 gap-8 max-w-7xl mx-auto">
            ...
            >
              <Card className="shadow-card sticky top-36">
                ...
                <CardContent className="p-0">
                  {rfqItems.length === 0 ? (
                    <div className="py-12 text-center">
                      ...
                      <p className="text-muted-foreground mb-2">No products selected</p>
